...
export class FiltroPeliculasComponent implements OnInit {
  ngOnInit(): void {
    /* valueChanges.subscribe esto permite reaccionar a los cambios en los valores de los campos de los formulario */
    this.leerValoresUrl();
    this.buscarPeliculas(this.form.value as FiltroPeliculas);
    this.form.valueChanges.subscribe(valores => {
      this.peliculas = this.peliculasOriginal;
      this.buscarPeliculas(valores as FiltroPeliculas);
      this.escribirParametrosEnBusqquedaUrl(valores as FiltroPeliculas);
    });
  ...
  escribirParametrosEnBusqquedaUrl(valores: FiltroPeliculas) {
    let querystrings = [];
